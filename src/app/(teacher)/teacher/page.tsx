...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <main className=" flex w-full items-center justify-center p-3">
        <div className="flex w-full flex-col gap-6 ">
          {/* Original resource upload section can go here */}
          <div className="rounded-lg bg-white p-6 shadow-md dark:bg-[#000000]">
            <h2 className="mb-4 font-bold text-2xl">Resource Upload</h2>
            <form
            ...
            >
              ...
              <div className="flex h-full flex-col gap-10 font-serif">
                ...
                <div>
                  <select
                    className="mt-8 w-[90%] border-gray-300 border-b bg-inherit text-2xl text-[#9CA3AF] outline-none placeholder:text-[#9CA3AF]"
                    id="year"
                    name="year"
                    onChange={handleInputChange}
                    value={formData.year}
                ...
                <div>
                  <select
                    className="mt-8 w-[90%] border-gray-300 border-b bg-inherit text-2xl text-[#9CA3AF] outline-none"
                    id="type"
                    name="type"
                    onChange={handleInputChange}
                    value={formData.type}
              ...
              <div className="flex flex-col gap-6">
                <div>
                  <label className="mb-4 block font-medium text-gray-400 text-sm">
