...
const questionPapers: QuestionPapers = {
  CSE: {
    MEFA: {
      'Question Paper 1':
        'https://utfs.io/f/P1G716yuMhtQZde2dtFmxvlGHNiMpS8X3RuJQWy29waPsk74',
      'Question Paper 2':
        'https://utfs.io/f/P1G716yuMhtQG0ufXvP17PuIF0Si5LKZ8WXOUfQnYpRMmzJ2',
      'Question Paper 3':
        'https://utfs.io/f/P1G716yuMhtQXuIXsJjV7aRSlAgJ5Ohx40iLuwbW1ZUnd6vq',
      'Question Paper 4':
        'https://utfs.io/f/P1G716yuMhtQpnTfud21dGZbO2yhoUa5CQgKYj8iAr7zEeTu',
      'Mid-2':
        'https://utfs.io/f/mK0Z48FDIuXriSZHO5o83eYnoCsZhqkyg94Rz1imVjf6dO0A',
      'Mid-1':
        'https://utfs.io/f/mK0Z48FDIuXrLrnkBnwzo4fbU8Hj2d0iD9YxZPghF1t3nLCk',
    },
    Java: {
      'Question Paper 1':
        'https://utfs.io/f/mK0Z48FDIuXreAyHBDUTvxkR13w2dPmYXOqzuNWMV7Q0ZrCA',
      'Question Paper 2':
        'https://utfs.io/f/mK0Z48FDIuXr1AP5etNAb5Q4qFDspItvC3kiKhVrldU9xBgX',
      'Question Paper 3':
        'https://utfs.io/f/mK0Z48FDIuXrcyDdwsPQ35OVhG0BLfyWdv9bcu2nUqI87kt1',
      'Question Paper 4':
        'https://utfs.io/f/mK0Z48FDIuXrjh26ys31R1OCMsIfKUgAEzJpd6YuklLZSD85',
    },
    DAA: {
      'Question Paper 1':
        'https://utfs.io/f/mK0Z48FDIuXraiuHgprxgXrAdsOHinlRxIYWkz50bKcCeQ2h',
      'Question Paper 2':
        'https://utfs.io/f/mK0Z48FDIuXrN4PFcUhOHlMNW2VArY4XQaJ6GTp5KjFztq9E',
      'Question Paper 3':
        'https://utfs.io/f/mK0Z48FDIuXrDdeW1eJLb7JIu6ZnPM9pcfrUFWCgGBAXatkq',
    },
    ADSAA: {
      'Mid-1':
        'https://utfs.io/f/mK0Z48FDIuXrLrnkBnwzo4fbU8Hj2d0iD9YxZPghF1t3nLCk',
      'Mid-2':
        'https://utfs.io/f/mK0Z48FDIuXrLrnkBnwzo4fbU8Hj2d0iD9YxZPghF1t3nLCk',
      'Model-Papper':
        'https://utfs.io/f/P1G716yuMhtQIGo47uscxKGvwLp0SyegDzTXUhu7lbJQIM5f',
    },
    'P&S': {
      'Question Paper 1':
        'https://utfs.io/f/mK0Z48FDIuXrEEeIPVb6TQmve472sBDdJzYIhGjbOLapg9xA',
      'Question Paper 2':
        'https://utfs.io/f/mK0Z48FDIuXrjWUEOD1R1OCMsIfKUgAEzJpd6YuklLZSD859',
    },
  },
};
  ...
  CSE: {
    ...
    ADSAA: {
      ADS_unit_1:
        'https://utfs.io/f/mK0Z48FDIuXrLrnkBnwzo4fbU8Hj2d0iD9YxZPghF1t3nLCk',
      ADS_unit_2:
        'https://utfs.io/f/mK0Z48FDIuXr5S4eZ5AOQIc2HJKdRsZj6Dw84ft1xhpvW5en',
      ADS_unit_3:
        'https://utfs.io/f/mK0Z48FDIuXrPjyVqd4T5jvfuLpFUaABNWq48wtkTXGnIYhD',
      hashing:
        'https://utfs.io/f/mK0Z48FDIuXrVCsXcdy6QpIwEYKor7laBH0DTVJAUqhtFRZC',
      material:
        'https://utfs.io/f/P1G716yuMhtQqRWG7YQbTBdmyaMhzQlHNx3Un2F0CtW7gvEj',
    },
    'P&S': {
      'Chapter 4':
        'https://utfs.io/f/mK0Z48FDIuXrj5R8In1R1OCMsIfKUgAEzJpd6YuklLZSD859',
      'Chapter 5':
        'https://utfs.io/f/mK0Z48FDIuXriSZHO5o83eYnoCsZhqkyg94Rz1imVjf6dO0A',
    },
    Java: {
      ...
      {selectedSubject === null ? (
        <div className="motion-preset-focus mt-6 flex flex-col items-start justify-center gap-12 overflow-x-auto">
          {Object.keys(subjects[selectedBranch] || {}).map((subject) => (
            <div
              className="relative flex w-full cursor-pointer flex-col border-[#f7eee334] border-b-2 p-3 text-3xl text-[#f7eee3] hover:text-[#FF5E00]"
              key={subject}
        ...
        <div>
          <div className="mt-16 flex items-center justify-between p-2">
            <button
              className="mb-4 flex rounded-full py-2 text-[#f7eee3] text-sm hover:text-[#FF5E00] lg:text-lg"
