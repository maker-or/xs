  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          className="rounded-lg bg-[#FF5E00] px-3 py-1 text-[#f7eee3] text-md "
      ...
      {isModalOpen && (
        ...
        >
          <div className="h-1/2 w-2/3 max-w-lg rounded-lg border-2 border-[#f7eee325] bg-[#0c0c0cae] p-4 backdrop-blur-lg">
            ...
            <UploadButton
              className="h-2/3 w-full rounded border-2 border-[#f7eee3]/30 border-dashed py-2 text-[#f7eee3] hover:border-[#f7eee3]"
      ...
      {images.length === 0 ? (
        ...
        <div className="item-center flex h-[250px] w-full flex-wrap gap-4 ">
          {images?.map((image, index) => (
            <div
              className="motion-scale-in-[0.83] flex flex-col items-center justify-center gap-6 "
              key={`${image.id}-${index}`}
            >
              <div
